...
export const yt = <i class="fa-solid fa-money-bill-trend-up"></i>
export const card = <i class="fa-solid fa-house-chimney"></i>
...
export const home = <i class="fa-solid fa-house-chimney"></i>

export const travelling = <i class="fa-solid fa-compass"></i>